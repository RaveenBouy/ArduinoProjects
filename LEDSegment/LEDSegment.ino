...
Metro delay2 = Metro(10);
Metro delay3 = Metro(10);
...
void ClearVars()
{
	tempVal1 = ""; 
	tempVal2 = "";
	tempSeconds = secondsCounter = secondsCounterTemp = secondsCounterTemp2 = seconds210thplace = 0;
}
...
void TimerForwardCounter()
{
	...
	while(secondsCounter<tempSeconds)
	{
		...
		testFunc(secondsCounterTemp, secondsCounterTemp2);

		if(delay1.check()) delay(1000);
	}
...
void testFunc(int secondsCounterTemp, int secondsCounterTemp2)
{
		if(delay2.check()) SetSecond(secondsCounterTemp);
		
		if(delay3.check()) SetSecond2(secondsCounterTemp2);	
}
